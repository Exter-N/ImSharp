...
public static partial class Im
{
    ...
    public static class Line
    {
        ...
        /// <param name="spacing"> Spacing from the resulting offset. If this is negative, if <paramref name="offsetFromStartX"/> is 0, this is set to 0, otherwise it is set to <seealso cref="Style.ItemSpacing"/>.X.</param>
        ...
        /// <summary> Undo the last carriage return after an item and stay on the same line while moving the cursor horizontally by <seealso cref="Style.ItemInnerSpacing"/>.X. </summary>
